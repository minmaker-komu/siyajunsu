...
<body>
    ...
    <div class="board_wrap">
        ...
        <div class="view3_title">
            <strong><?php echo $_REQUEST['food_title'];?></strong>

            <h1><?php echo $_REQUEST['food_where'];?></h1>

            <h1><?php echo $_REQUEST['food_date'];?></h1>

            <img src= "<?php echo $_GET['food_img']; ?>" >

            <p><?php echo $_REQUEST['food_content'];?></p>
