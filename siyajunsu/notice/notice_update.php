...
<body>
    ...
    <div class="board_wrap">
        ...
        <?php
            ...
            $sql = "SELECT * FROM tb_notice where idx= $_GET[idx]";
        ...
        <div class="board_write_wrap">
            ...
            <form action="notice_update_ok.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="board_write_wrap">
                    <div class="board_write">
                        <div class="title">
                            <dl>
                    ...
                    <div class="bt_wrap">
                        <input type="submit" href="notice_list.php" class="on" value="수정">
