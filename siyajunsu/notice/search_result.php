            ...
            <div class="board_list">
                ...
                <!-- 게시물 -->
                    ...
                    <?php
                        ...
                        switch($cate){
                            case "title":
                                $sql_page = "SELECT * FROM tb_notice WHERE title LIKE '%$search%' ORDER BY idx DESC limit $start, $per";
                                break;
                            case "content":
                                $sql_page = "SELECT * FROM tb_notice WHERE content LIKE '%$search%' ORDER BY idx DESC limit $start, $per";    
                                break;
                            case "name":
                                $sql_page = "SELECT * FROM tb_notice WHERE writer_name LIKE '%$search%' ORDER BY idx DESC limit $start, $per";    
                                break;
                        }
