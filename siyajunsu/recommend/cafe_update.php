...
<body>
    ...
    <div class="board_wrap">
        ...
        <div class="board_write_wrap">
            ...
            <form action="cafe_update_ok.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="board_write_wrap">
                    <div class="board_write">
                        <div class="title">
                            <dl>
                    ...
                    <div class="bt_wrap">
                        <input type="submit" href="cafe_list.php" class="on" value="수정">
                        <a href="cafe_view.php">취소</a>
                    </div>
                </div>
            </form>
        </div>
