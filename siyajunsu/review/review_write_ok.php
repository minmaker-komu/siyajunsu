<?php
    ...
    $sql = "INSERT INTO tb_review(title, content, place, concert_date, writer_name, writer_id, date, hit, file) VALUES ('$title', '$content','$place','$date', '$writer_name', '$writer_id', now(), 0, '$arrayString');";

    $res = mysqli_query($conn, $sql);

    if($res) {
        echo "<script>alert('공연후기가 작성되었습니다.');";
