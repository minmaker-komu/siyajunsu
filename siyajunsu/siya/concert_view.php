    ...
    <div class="board_wrap">
        ...
        <div class="board_list_wrap">
            ...
            <div class="board_page">
                <?php 
                    echo "<a class=\"bt first\" href=\"concert_view.php?page=1\"> << </a>";
                    $pre = $page - 1;
                    echo "<a class=\"bt prev\" href=\"concert_view.php?page=$pre\"> < </a>";
                    ...
                    while($page_num <= $total_page){
                        if($page==$page_num){
                            echo "<a class=\"num on\" href=\"concert_view.php?page=$page_num\">$page_num </a>";
                        } else {
                            echo "<a class=\"num\" href=\"concert_view.php?page=$page_num\">$page_num </a>"; }
                        $page_num++;
                    }

                    $next = $page + 1;
                    echo "<a class=\"bt next\" href=\"concert_view.php?page=$next\"> > </a>";

                    echo "<a class=\"bt last\" href=\"concert_view.php?page=$total_page\"> >> </a>";
