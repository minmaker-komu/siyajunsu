...
<body>
    ...
    <div class="board_wrap">
        ...
        <div class="board_view_wrap">
                ...
                <div class="cont">
                    ...
                    <?php 
                        if(!$row['file']){
                            ...
                            //echo "<br><img src='image/$row[file]'></img>";
            ...
            <div class="bt_wrap">
                <a href="concert_view.php" class="on">목록</a>
                <?php
                    if($_SESSION['userid'] == $row['writer_id']){ ?>
                        <a href="update2.php?idx=<?=$row['idx']?>">수정</a>
                        <a href="delete2_ok.php?idx=<?=$row['idx']?>">삭제</a>
                <?php } ?>
            </div>
            ...
            <!-- 더보기 버튼 생성 -->
            <?php
            // $query="select * from reply where status=1 and bid=".$row['idx']." order by memoid desc limit 5";
            // $sql4="SELECT * FROM reply WHERE bid=".$row['idx']." ORDER BY memoid DESC";
            ...
            <!-- 게시물 번호 -->
            <!-- <input type="hidden" name="reply1boardnum" value="<?php echo $bid; ?>"> -->
            <!-- 댓글 번호 -->
